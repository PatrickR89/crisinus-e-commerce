            ...
            <div className="content glass">
                ...
                <div className="body">
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.clientNameError &&
                            translation.clientNameMsg
                        }
                        type="text"
                        name="clientName"
                        id="clientLastName"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.clientLastNameError &&
                            translation.clientLastNameMsg
                        }
                        type="text"
                        name="clientLastName"
                        id="clientLastName"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.clientEmailError &&
                            translation.clientEmailMsg
                        }
                        type="email"
                        name="clientEmail"
                        id="clientEmail"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.cityError && translation.clientCityMsg
                        }
                        type="text"
                        name="city"
                        id="city"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.postalCodeError &&
                            translation.clientPostalCodeMsg
                        }
                        type="number"
                        name="postalCode"
                        id="postalCode"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.streetNameError &&
                            translation.clientStreetNameMsg
                        }
                        type="text"
                        name="streetName"
                        id="streetName"
                    ...
                    <TextField
                        ...
                        variant="standard"
                        helperText={
                            cartError.streetNumberError &&
                            translation.clientStreetNumberMsg
                        }
                        type="text"
                        name="streetNumber"
                        id="streetNumber"
